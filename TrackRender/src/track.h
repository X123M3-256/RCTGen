...
enum
{
	...
	TRACK_SPECIAL_BRAKE_OPEN = 0x20000000, // Separate group for clarity
	TRACK_SPECIAL_BRAKE_CLOSED = 0x30000000, // Separate group for clarity
	TRACK_SPECIAL_BLOCK_BRAKE = 0x40000000,

	// Booster
	TRACK_SPECIAL_BOOSTER = 0x50000000,
	TRACK_SPECIAL_LAUNCHED_LIFT = 0x60000000,
	TRACK_SPECIAL_VERTICAL_BOOSTER = 0x70000000,
