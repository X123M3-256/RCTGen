...
enum
{
	...
	VIEW_EXTRUDE_BEHIND=2,
	VIEW_EXTRUDE_IN_FRONT=4,
	VIEW_MASK_END=8
};
...
enum track_groups
{
	...
	TRACK_GROUP_STEEP_BANK_TRANSITIONS=0x4000000000,
        TRACK_GROUP_LARGE_STEEP_SLOPED_TURNS=0x8000000000,
	TRACK_GROUP_BANKED_BARREL_ROLLS=0x10000000000,
	TRACK_GROUP_BANKED_INLINE_TWISTS=0x20000000000,
	TRACK_GROUP_BANKED_ZERO_G_ROLLS=0x40000000000,
	TRACK_GROUP_DIAGONAL_INVERSIONS=0x80000000000
};
...
OFFSET_STEEP=2,
OFFSET_BANK=3,
OFFSET_GENTLE_BANK_LEFT=4,
OFFSET_GENTLE_BANK_RIGHT=5,
OFFSET_INVERTED=6,
OFFSET_DIAGONAL=7,
OFFSET_DIAGONAL_BANK=8,
OFFSET_DIAGONAL_GENTLE=9,
OFFSET_DIAGONAL_STEEP=10
};
