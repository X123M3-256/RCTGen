...
enum
{
	...
	// Unterstützung und Extrudierung
	...
	TRACK_SPECIAL_SLOPED_BRAKE = 0x20000000,
	TRACK_SPECIAL_BRAKE_OPEN = 0x30000000, // Separate group for clarity
	TRACK_SPECIAL_BRAKE_CLOSED = 0x40000000, // Separate group for clarity
	TRACK_SPECIAL_BLOCK_BRAKE = 0x50000000,

	// Booster
	TRACK_SPECIAL_BOOSTER = 0x60000000,
	TRACK_SPECIAL_LAUNCHED_LIFT = 0x70000000,
	TRACK_SPECIAL_VERTICAL_BOOSTER = 0x80000000,
...
enum track_groups : uint64_t
{
	TRACK_GROUP_FLAT = 0x1ull,
	TRACK_GROUP_BRAKES = 0x2ull,
	TRACK_GROUP_GENTLE_SLOPES = 0x4ull,
	TRACK_GROUP_STEEP_SLOPES = 0x8ull,
	TRACK_GROUP_VERTICAL_SLOPES = 0x10ull,
	TRACK_GROUP_TURNS = 0x20ull,
	TRACK_GROUP_SLOPED_TURNS = 0x40ull,
	TRACK_GROUP_DIAGONALS = 0x80ull,
	TRACK_GROUP_BANKED_TURNS = 0x100ull,
	TRACK_GROUP_BANKED_SLOPED_TURNS = 0x200ull,
	TRACK_GROUP_S_BENDS = 0x400ull,
	TRACK_GROUP_HELICES = 0x800ull,
	TRACK_GROUP_LARGE_SLOPE_TRANSITIONS = 0x1000ull,
	TRACK_GROUP_BARREL_ROLLS = 0x2000ull,
	TRACK_GROUP_INLINE_TWISTS = 0x4000ull,
	TRACK_GROUP_HALF_LOOPS = 0x8000ull,
	TRACK_GROUP_QUARTER_LOOPS = 0x10000ull,
	TRACK_GROUP_CORKSCREWS = 0x20000ull,
	TRACK_GROUP_LARGE_CORKSCREWS = 0x40000ull,
	TRACK_GROUP_BOOSTERS = 0x80000ull,
	TRACK_GROUP_LAUNCHED_LIFTS = 0x100000ull,
	TRACK_GROUP_TURN_BANK_TRANSITIONS = 0x200000ull,
	TRACK_GROUP_MEDIUM_HALF_LOOPS = 0x400000ull,
	TRACK_GROUP_LARGE_HALF_LOOPS = 0x800000ull,
	TRACK_GROUP_ZERO_G_ROLLS = 0x1000000ull,
	TRACK_GROUP_SMALL_SLOPE_TRANSITIONS = 0x2000000ull,
	TRACK_GROUP_STEEP_SLOPED_TURNS = 0x4000000ull,
	TRACK_GROUP_LARGE_SLOPED_TURNS = 0x8000000ull,
	TRACK_GROUP_LARGE_BANKED_SLOPED_TURNS = 0x10000000ull,
	TRACK_GROUP_VERTICAL_LOOPS = 0x20000000ull,
	TRACK_GROUP_VERTICAL_BOOSTERS = 0x40000000ull,
	TRACK_GROUP_DIAGONAL_BRAKES = 0x80000000ull,
	TRACK_GROUP_SLOPED_BRAKES = 0x100000000ull,
	TRACK_GROUP_VERY_SMALL_TURNS = 0x200000000ull,
};
...
enum models
{
	...
	MODEL_BASE,
	MODEL_SPECIAL_BRAKE,
	MODEL_SPECIAL_SLOPED_BRAKE,
	MODEL_SPECIAL_BRAKE_OPEN,
	MODEL_SPECIAL_BRAKE_CLOSED,
	MODEL_SPECIAL_BLOCK_BRAKE,
	MODEL_SPECIAL_BOOSTER,
	MODEL_SPECIAL_VERTICAL_BOOSTER,
	MODEL_SPECIAL_LAUNCHED_LIFT,
...
typedef struct
{
	...
	track_section_t brake_open;
	track_section_t brake_closed;
